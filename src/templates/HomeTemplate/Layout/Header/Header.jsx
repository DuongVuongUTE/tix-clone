      ...
      <header className="bg-gray-800 text-white fixed top-0 left-0 w-full z-50 px-4">
        <div className="container flex justify-between h-16 mx-auto">
          ...
          <ul className="items-stretch hidden space-x-3 lg:flex">
            ...
            {/* <li className="flex">
              <NavLink to="/" className="flex items-center px-4 font-semibold">
                Phim
              </NavLink>
            </li> */}
          </ul>
          <div className="items-center flex-shrink-0 hidden lg:flex">
            <Link to="/login">
              <button className="self-center px-6 py-3 rounded font-semibold">
                Sign in
              </button>
            </Link>
            <Link to="/register">
              <button className="self-center px-6 py-3 font-semibold rounded bg-yellow-500 text-gray-900">
                Sign up
              </button>
            </Link>
          </div>
